  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[70vh] p-4 text-center">
      <motion.div
        ...
        className="w-20 h-20 bg-slate-900 border border-slate-800 rounded-2xl flex items-center justify-center mb-6 shadow-xl relative"
      >
        <Bookmark size={32} className="text-blue-500" />
        <div className="absolute -bottom-2 -right-2 bg-slate-800 border border-slate-700 rounded-full p-1.5 shadow-sm">
          <Lock size={12} className="text-slate-400" />
        </div>
      </motion.div>
      <h1 className="text-2xl md:text-3xl font-bold text-white mb-3">Saved Intelligence</h1>
