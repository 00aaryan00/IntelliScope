  ...
  return (
    <div className="p-4 md:p-8 max-w-3xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <header className="border-b border-slate-800 pb-6">
        <h1 className="text-2xl md:text-3xl font-bold tracking-tight text-white mb-2">Profile</h1>
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-xl p-8 text-center space-y-4 shadow-sm">
        <div className="w-24 h-24 bg-slate-800 rounded-full flex items-center justify-center mx-auto border-4 border-slate-950 shadow-xl">
          <User size={40} className="text-slate-500" />
        </div>
        <div>
          <h2 className="text-xl font-bold text-white">Guest User</h2>
          <p className="text-slate-400 text-sm mt-1">You are browsing the dashboard anonymously.</p>
        </div>
        <div className="pt-4">
